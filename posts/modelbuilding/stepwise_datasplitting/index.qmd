...
This post is partly a expansion of a comment I made about training/test sets in a [previous post](../../05-mlr3_basic_modelling/index.qmd). It is the first part of a four part series on model fitting and validation.
